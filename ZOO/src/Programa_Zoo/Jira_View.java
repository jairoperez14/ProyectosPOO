...
public class Jira_View extends JFrame {
	...
	Jirafa jira = new Jirafa ("Jirafa", "Las crias se desarrollan en el vientre de su madre", "Herbivoros", "Pacifico", "Terrestre", 3);
		...
		public Jira_View(){
			...
			tarep.setText(jira.getReproduccion());
			...
			taalim.setText(jira.getAlimentacion());
			...
			tatem.setText(jira.getTemperamento());
			...
			tacan.setText(""+jira.getCantidad());
			...
			taconsejo.setText(jira.pacifico());
