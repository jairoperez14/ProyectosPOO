...
public class Lor_View extends JFrame {
	...
	Loro lor = new Loro ("Loro", "Las crias nacen de huevos", "Omnivoro", "Pacifico", "Aereo", 8);
		...
		public Lor_View(){
			...
			tarep.setText(lor.getReproduccion());
			...
			taalim.setText(lor.getAlimentacion());
			...
			tatem.setText(lor.getTemperamento());
			...
			taconsejo.setText(lor.pacifico());
