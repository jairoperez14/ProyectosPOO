...
public class Coco_View extends JFrame {
	...
	Cocodrilo coco = new Cocodrilo ("Cocodrilo", "Las crias nacen de huevos", "Carnivoro", "Agresivo", "Semiacuatico", 2);
		...
		public Coco_View(){
			...
			tarep.setText(coco.getReproduccion());
			...
			taalim.setText(coco.getAlimentacion());
			...
			tatem.setText(coco.getTemperamento());
			...
			tacan.setText(""+coco.getCantidad());
			...
			taconsejo.setText(coco.agresivo());
