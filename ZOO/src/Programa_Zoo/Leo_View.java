...
public class Leo_View extends JFrame {
	...
	Leon leo = new Leon ("Leon", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Terrestre", 1);
		...
		public Leo_View(){
			...
			tarep.setText(leo.getReproduccion());
			...
			taalim.setText(leo.getAlimentacion());
			...
			tatem.setText(leo.getTemperamento());
			...
			taconsejo.setText(leo.agresivo());
