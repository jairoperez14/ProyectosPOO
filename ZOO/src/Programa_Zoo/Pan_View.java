...
public class Pan_View extends JFrame {
	...
	Oso_Panda pan = new Oso_Panda ("Oso Panda", "Las crias se desarrollan en el vientre de su madre", "Herbivoro", "Pacifico", "Terrestre", 3);
		...
		public Pan_View(){
			...
			tarep.setText(pan.getReproduccion());
			...
			taalim.setText(pan.getAlimentacion());
			...
			tatem.setText(pan.getTemperamento());
			...
			taconsejo.setText(pan.pacifico());
