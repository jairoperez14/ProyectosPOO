...
public class Foc_View extends JFrame {
	...
	Foca foc = new Foca ("Foca", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Semiacuatico", 4);
		...
		public Foc_View(){
			...
			tarep.setText(foc.getReproduccion());
			...
			taalim.setText(foc.getAlimentacion());
			...
			tatem.setText(foc.getTemperamento());
			...
			taconsejo.setText(foc.agresivo());
