...
public class Pol_View extends JFrame {
	...
	Oso_Polar pol = new Oso_Polar ("Oso Polar", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Semiacuatico", 2);
		...
		public Pol_View(){
			...
			tarep.setText(pol.getReproduccion());
			...
			taalim.setText(pol.getAlimentacion());
			...
			tatem.setText(pol.getTemperamento());
			...
			taconsejo.setText(pol.agresivo());
