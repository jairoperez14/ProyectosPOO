...
public class Leopar_View extends JFrame {
	...
	Leopardos leopar = new Leopardos ("Leopardo", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Terrestre", 4);
		...
		public Leopar_View(){
			...
			tarep.setText(leopar.getReproduccion());
			...
			taalim.setText(leopar.getAlimentacion());
			...
			tatem.setText(leopar.getTemperamento());
			...
			tahab.setText(leopar.getHabitat());
			...
			tacan.setText(""+leopar.getCantidad());
			...
			taconsejo.setText(leopar.agresivo());
			taconsejo.setFont(new Font("Monospaced", Font.PLAIN, 14));
