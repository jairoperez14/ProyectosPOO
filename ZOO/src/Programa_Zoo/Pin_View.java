...
public class Pin_View extends JFrame {
	...
	Pinguino pin = new Pinguino ("Pinguino", "Las crias nacen de huevos", "Carnivoro", "Pacifico", "Semiacuatico", 4);
		...
		public Pin_View(){
			...
			tarep.setText(pin.getReproduccion());
			...
			taalim.setText(pin.getAlimentacion());
			...
			tatem.setText(pin.getTemperamento());
			...
			taconsejo.setText(pin.pacifico());
