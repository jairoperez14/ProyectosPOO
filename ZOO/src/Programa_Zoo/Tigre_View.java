...
public class Tigre_View extends JFrame {
	...
	Tigres tig = new Tigres ("Tigre", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Terrestre", 3);
		...
		public Tigre_View(){
			...
			tarep.setText(tig.getReproduccion());
			...
			taalim.setText(tig.getAlimentacion());
			...
			tatem.setText(tig.getTemperamento());
			...
			taconsejo.setText(tig.agresivo());
