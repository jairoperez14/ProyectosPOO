...
public class Rino_View extends JFrame {
	...
	Rinoceronte rino = new Rinoceronte ("Rinoceronte", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Terrestre", 3);
		...
		public Rino_View(){
			...
			tarep.setText(rino.getReproduccion());
			...
			taalim.setText(rino.getAlimentacion());
			...
			tatem.setText(rino.getTemperamento());
			...
			tacan.setText(""+rino.getCantidad());
			...
			taconsejo.setText(rino.agresivo());
