...
public class Gori_View extends JFrame {
	...
	Gorillas gori = new Gorillas ("Gorilla", "Las crias se desarrollan en el vientre de su madre", "Carnivoro", "Agresivo", "Terrestre", 6);
		...
		public Gori_View(){
			...
			tarep.setText(gori.getReproduccion());
			...
			taalim.setText(gori.getAlimentacion());
			...
			tatem.setText(gori.getTemperamento());
			...
			tacan.setText(""+gori.getCantidad());
			...
			taconsejo.setText(gori.agresivo());
