...
public class Aves_View extends JFrame {
	...
	Avestruz aves = new Avestruz ("Avestruz", "Las crias nacen de huevos", "Omnivoro", "Agresivo", "Terrestre", 3);
		...
		public Aves_View(){
			...
			tarep.setText(aves.getReproduccion());
			...
			taalim.setText(aves.getAlimentacion());
			...
			tatem.setText(aves.getTemperamento());
			...
			tacan.setText(""+aves.getCantidad());
			...
			taconsejo.setText(aves.agresivo());
